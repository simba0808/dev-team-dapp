...
const BalanceCard: FC<Props> = ({token=true, type, amount, color='blue', position='top-left', size='small'}) => {
  return (
    <>
      <div className='relative flex-1 py-4 xs:py-8 lg:py-20 text-center border border-gray-500 rounded-2xl bg-black/20 backdrop-blur-xl shadow-2xl uppercase overflow-clip'>
        <p className='text-[12px] xs:text-[20px] lg:text-[26px] font-bold mb-4'>{type}</p>
